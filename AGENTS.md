...
- Large menu imports perform per-item identity and feature synchronization inside one atomic transaction; use the import-specific 30-second transaction timeout rather than Prisma's five-second default.
