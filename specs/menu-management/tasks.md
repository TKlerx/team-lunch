...
- [x] T021 [US4] Batch large atomic imports, refresh reused identity snapshots, reject more than 1,000 items before writing, translate transaction timeouts, and regress with the 149-item Indish fixture
