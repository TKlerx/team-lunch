...
-  M specs/food-selection/tasks.md
-  M specs/menu-management/tasks.md
-  M specs/multi-office/tasks.md
-  M specs/poll-lifecycle/tasks.md
-  M specs/shopping-list/tasks.md
