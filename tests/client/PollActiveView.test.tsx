...
describe('PollActiveView', () => {
  const menus = [
    ...
    makeMenu({ id: 'menu-2', name: 'Sushi Bar', items: [{ id: 'item-2', menuId: 'menu-2', name: 'California Roll', description: null, price: null, tags: [], allergens: [], additives: [], createdAt: '2026-01-01T00:00:00Z' }] }),
  ];
